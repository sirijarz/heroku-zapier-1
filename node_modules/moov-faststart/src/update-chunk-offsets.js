...
function updateChunkOffsets(moov, options) {
    const atoms = moov.data; // TODO: does this need to be type checked?
    ...
    atom_1.traverseAtoms(atoms, atom => {
...
function updateChunkAtom(atom, totalOffset, options) {
    ...
    for (let i = 0; i < entries; i++) {
        ...
        if (isCo64(atom.kind)) {
            const newVal64 = Number((BigInt(atom.data.readUInt32BE(cur)) << 32) | BigInt(atom.data.readUInt32BE(cur + 4))) +
                totalOffset;
...
//# sourceMappingURL=update-chunk-offsets.js.map